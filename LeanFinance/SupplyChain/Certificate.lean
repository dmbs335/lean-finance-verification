...
theorem DynamicBottleneckCertificate.dataset_available
    ...
    dataset.availableAt ≤ decision.decisionTime := by
  change Backtest.DatasetAvailableAt dataset decision.decisionTime
  exact (Backtest.no_future_information_data decision
